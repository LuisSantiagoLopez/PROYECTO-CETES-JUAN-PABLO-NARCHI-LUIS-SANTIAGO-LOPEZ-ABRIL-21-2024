...
ruta_archivo = "VectorAnalitico24h.xls"
ruta_archivo_viejo = "VectorViejo.xls"
...
df_pemex_pip = pd.read_excel('PIP.xls',skiprows=1)
...
df_cfe_pip = pd.read_excel('PIP.xls',skiprows=1)
...
pemex_pip_t_1 = pd.read_excel('PIPViejo.xls',skiprows=1)
...
cfe_pip_t_1 = pd.read_excel('PIPViejo.xls',skiprows=1)
